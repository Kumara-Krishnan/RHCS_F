...
public class NormalizeInput {
     ...
     *
     * @param input The input array to be normalized.
     * @param type What type of normalization to use.
     */
     ...
     * input.
     *
     * @param pattern The input pattern to create.
     * @param extra The synthetic input.
