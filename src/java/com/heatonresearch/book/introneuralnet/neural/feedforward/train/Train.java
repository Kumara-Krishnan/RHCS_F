...
/**
 * Train: Interface for all feedforward neural network training methods. There
 * are currently three training methods define:
 *
 * Backpropagation Genetic Algorithms Simulated Annealing
 *
 * @author Jeff Heaton
 * @version 2.1
 */
