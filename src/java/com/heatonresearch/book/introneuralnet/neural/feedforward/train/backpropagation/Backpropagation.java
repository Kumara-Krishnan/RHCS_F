...
public class Backpropagation implements Train {
     ...
     * @param input
     * @param ideal
     * @param learnRate The rate at which the weight matrix will be adjusted
     * based on learning.
     * @param momentum The influence that previous iteration's training deltas
     * will have on the current iteration.
     */
